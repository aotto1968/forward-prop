...
model-hebb-mnist:   ; $(MAKE) -s -C reference model-hebb-mnist
model-adam-cifar:   ; $(MAKE) -s -C reference model-adam-cifar
model-hebb-cifar:   ; $(MAKE) -s -C reference model-hebb-cifar
...
test-mnist-hebbian: reference
	@test -f models/mnist-hebbian-h512-e10/weights.meta || $(MAKE) model-hebb-mnist
	@echo -e "\n=== Bin32 Hebbian MNIST (H=512, 10 ep) ==="
	@echo -n "start..." && ./reference/mnist-mlp-bin32-hebbian-ifc-xnor.exe \
	  --model models/mnist-hebbian-h512-e10 --evalN 10000 2>&1 | grep '^REPORT'

test-mnist: test-mnist-otto test-mnist-adam test-mnist-hebbian

# ── CIFAR-10 ───────────────────────────────────────────────
test-cifar-otto: cifar
	@test -f models/cifar-otto-h256-e10/model.otto || $(MAKE) model-otto-cifar
	@echo -e "\n=== Otto Score CIFAR-10 (H=256, 5 ep) ==="
	@./cifar/cifar-mlp-bin32-otto-trn-xnor.exe \
	  --model models/cifar-otto-h256-e10/model.otto --evalN 10000 --encoding latest 2>&1 | grep '^REPORT'

test-cifar-adam: reference
	@test -f models/cifar-adam-h256-e10/weights.meta || $(MAKE) model-adam-cifar
	@echo -e "\n=== Float32 AdamW CIFAR-10 (H=256, 3 ep) ==="
	@./reference/cifar-mlp-flt32-adam-ifc.exe \
	  --model models/cifar-adam-h256-e10 --evalN 10000 2>&1 | grep '^REPORT'

test-cifar-hebbian: reference
	@test -f models/cifar-hebbian-h256-e10/weights.meta || $(MAKE) model-hebb-cifar
	@echo -e "\n=== Bin32 Hebbian CIFAR-10 (H=256, 3 ep) ==="
	@./reference/cifar-mlp-bin32-hebbian-ifc-xnor.exe \
	  --model models/cifar-hebbian-h256-e10 --evalN 10000 2>&1 | grep '^REPORT'
