/*
 * otto-score-ifc/fashion/ki-config.h — Fashion-MNIST static configuration
 * ======================================================================
 ...
 * to the shared headers. Symlinked into mnist-fashion/ki-config.h.
 *
 ...
 * to data/prepped/. Adjust per dataset as needed.
...
#define KI_NC                   (KI_PX / KI_PX_PER_CONT_W)  /* Container: 784/4=196 bei 8bit */
